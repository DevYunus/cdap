...
/**
 * Interface used to start preview and also retrieve the information associated with the preview.
 */
public interface PreviewManager {
  ...
  /**
   * Get the list of loggeres used in the specified preview.
   * @param preview the application id of the preview
   * @return {@link List} of loggeres used in the preview
   * @throws NotFoundException if preview application is not found
   */
  List<String> getLoggers(ApplicationId preview) throws NotFoundException;
