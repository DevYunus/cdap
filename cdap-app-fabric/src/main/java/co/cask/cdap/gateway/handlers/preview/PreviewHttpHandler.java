...
public class PreviewHttpHandler extends AbstractAppFabricHttpHandler {
  ...
  @Inject
  public PreviewHttpHandler(CConfiguration cConf, Configuration hConf, DiscoveryService discoveryService,
   ...
   */
  @VisibleForTesting
  public Injector createPreviewInjector(ApplicationId applicationId, Set<String> datasetNames) {
    ...
    try {
      ...
      File previewDir = Files.createTempDirectory(previewDirPath, applicationId.getApplication()).toFile();
